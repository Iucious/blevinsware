...
function library:Init()
    ...
    function self:selectTab(tab)
        ...
        self.main.Size = UDim2.new(0, 16 + ((#tab.columns < 2 and 2 or #tab.columns) * 250), 0, 155)
        self.currentTab = tab
    ...
    Meta.__newindex =
        ...
        function(t, i, v)
            ...
            if library == "MouseIconEnabled" then
...
local SettingsTab = library:AddTab("1")
local SettingsColumn = SettingsTab:AddColumn()
local SettingsColumn2 = SettingsTab:AddColumn()
local SettingSection = SettingsColumn:AddSection("Cheat Type")

SettingSection:AddList({flag = "Flag", value = "", values = {"Latest Build"}})
callback = function()
end
...
SettingSection:AddButton(
    {
        ...
        callback = function()
            getgenv().library:Unload()
            wait(3)
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Viegooo/femboyware/main/femboyware", true))()
        end
    }
)

local SettingsTab1 = library:AddTab("Informations")
local SettingsColumn = SettingsTab1:AddColumn()
local SettingsColumn2 = SettingsTab1:AddColumn()
local SettingSection = SettingsColumn:AddSection("Menu")

local SettingsTab2 = library:AddTab("Customize")
local SettingsColumn = SettingsTab2:AddColumn()
local SettingsColumn2 = SettingsTab2:AddColumn()
local SettingsSection4 = SettingsColumn2:AddSection("uhh")
local SettingSection = SettingsColumn:AddSection("Menu")
