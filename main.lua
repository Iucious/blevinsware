...
local nigger =
    loadstring(game:HttpGet "https://raw.githubusercontent.com/CatzCode/PikaHub/main/Libraries/UI/bruh.lua")()
nigger:CreateWatermark("blevinsware | Build: BETA | Version: 1.0")
nigger.theme.accentcolor = Color3.fromRGB(0, 0, 0)
nigger.theme.accentcolor2 = Color3.fromRGB(0, 0, 0)
nigger.theme.topheight = 45
nigger.theme.TextColor = Color3.fromRGB(255, 255, 255)
...
local MainUIColor = COL3RGB(255, 182, 193)
...
function library:New(name)
    ...
    TextLabel.Size =
        UDim2.new(0, txt:GetTextSize(name, 15, Enum.Font.Code, Vector2.new(700, TextLabel.AbsoluteSize.Y)).X, 0, 29)
    TextLabel.Font = Enum.Font.Code
    TextLabel.Text = name
    ...
    TabButtons.BackgroundColor3 = Color3.fromRGB(255, 182, 193)
    TabButtons.BackgroundTransparency = 1
    TabButtons.Position = UDim2.new(TextLabel.Size.X.Scale, TextLabel.Size.X.Offset + 255, 0, 0)
    ...
    function menu:Tab(text)
        ...
        TextButton.BackgroundColor3 = Color3.fromRGB(255, 182, 193)
        TextButton.BackgroundTransparency = 1
        TextButton.Size = UDim2.new(0, txt:GetTextSize(text, 12, Enum.Font.Code, Vector2.new(700, 700)).X + 12, 1, 0)
        TextButton.Font = Enum.Font.Code
        TextButton.Text = text
        TextButton.TextColor3 = Color3.fromRGB(255, 182, 193)
        ...
        TabGui.Name = "TabGui"
        TabGui.Parent = Tabs
        TabGui.BackgroundColor3 = COL3RGB(255, 182, 193)
        ...
        Left.Name = "Left"
        Left.Parent = TabGui
        Left.BackgroundColor3 = COL3RGB(255, 182, 193)
        ...
        Right.Name = "Right"
        Right.Parent = TabGui
        Right.BackgroundColor3 = COL3RGB(255, 182, 193)
            ...
            function MSector:Tab(text)
                ...
                function tab:Element(type, text, data, callback)
                        ...
                        local function update()
                            if Element.value.Toggle then
                                ...
                                tween =
                                    ...
                                    Color,
                                    TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                    {BackgroundColor3 = COL3RGB(0, 0, 0)}
                                )
                                library:Tween(
                                    TextLabel,
                                    TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                    ...
                    elseif type == "Slider" then
                        ...
                        UIGradient.Color =
                            ColorSequence.new {
                            ColorSequenceKeypoint.new(0, MainUIColor),
                            ColorSequenceKeypoint.new(1, MainUIColor)
                        }
...
local gui = library:New("blevinsware")
...
antiaim:Element(
    "Dropdown",
    "pitch",
    {options = {"none", "up", "down", "huge", "custom", "zero", "180", "random", "Random AA"}}
)
        ...
        while wait(1 / 16) do
            ...
            if
                LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("UpperTorso") and
                    values.rage.fakelag.enabled.Toggle
             then
                if
                    LagTick ==
...
self:Element(
    ...
    function(val)
        ...
        ) * CFAngles(0, 0, values.visuals.self.roll.Slider / 50)
    end
)
self:Element(
    "Slider",
...
world:Element(
    "Dropdown",
    "hitsound",
    {options = {"none", "skeet", "neverlose", "rust", "bag", "baimware", "cod", "minecraft", "godlike", "fard"}}
)
...
movement:Element("Slider", "speed", {min = 0, max = 100, default = 53})
        ...
        if tbl.Toggle then
            while values.misc.chat["chat spam"].Toggle do
                game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(
                    values.misc.chat.type.Dropdown == "standard" and "Im using blevinsware" or
                        "blevinsware > https://discord.gg/4dmrMCkxC4",
                    false,
                    "Innocent",
                    false,
                    true
...
grenades:Element(
    ...
    {},
    function()
        CreateHitElement("Crashing the server..", Color3.new(1, 0.5, 0.5))
        while true do
            pcall(
                function()
                    game:GetService("RunService").RenderStepped:Wait()
                    ...
                    pcall(
                        function()
                            ...
                            for i = 1, values.misc.grenades["ping limit"].Slider, 1 do
                                game:GetService("ReplicatedStorage").Events.DropMag:FireServer(
                                    LocalPlayer.Character.Gun.Mag
                                )
...
animations:Element(
    "Dropdown",
    "animation",
    {options = {"floss", "barrel roll", "default", "lil nas x", "dolphin", "monkey"}},
    function(tbl)
        Dance.AnimationId =
            tbl.Dropdown == "floss" and "rbxassetid://5917459365" or
            tbl.Dropdown == "default" and "rbxassetid://3732699835" or
            tbl.Dropdown == "barrel roll" and "rbxassetid://136801964" or
            tbl.Dropdown == "lil nas x" and "rbxassetid://5938396308" or
            tbl.Dropdown == "dolphin" and "rbxassetid://5938365243" or
            tbl.Dropdown == "monkey" and "rbxassetid://3716636630"
...
CreateHitElement("Loading Finity...", Color3.new(1, 1, 0))
        ...
        if PlayerIsAlive then
            ...
            if
             ...
             then
                for _, Player in pairs(Players:GetPlayers()) do
                    if
                        Player.Character and Player.Team ~= LocalPlayer.Team and
                                ...
                                if Client.gun:FindFirstChild("Melee") and values.rage.aimbot["knifebot"].Toggle then
                                    ...
                                    for _, Hitbox in ipairs(Hitboxes) do
                                        ...
                                        if values.rage.aimbot["automatic penetration"].Toggle then
                                            ...
                                            local Penetration = Client.gun.Penetration.Value * 0.7
                                            local Ray1 =
                                                RAY(
                                                Origin,
                                            ...
                                            if Hit and Multipliers[Hit.Name] ~= nil then
                                                ...
                                                if Player:FindFirstChild("Kevlar") then
                                                    if FIND(Hit.Name, "Head") then
                                                        if Player:FindFirstChild("Helmet") then
                                                            Damage = (Damage / 110) * Client.gun.ArmorPenetration.Value
                                                        end
                                                    else
                                                        Damage = (Damage / 110) * Client.gun.ArmorPenetration.Value
                                                    end
                                                ...
                                                Damage =
                                                    Damage *
                                                    (Client.gun.RangeModifier.Value /
                                                        110 ^ ((Origin - Hit.Position).Magnitude / 500))
                                                if Damage >= Stats["minimum damage"].Slider then
                                                    RageGuy = Hit
                                                    RageTarget = Hit
                                                    if not values.rage.aimbot["silent aim"].Toggle then
            ...
            if values.rage.angles.enabled.Toggle and not DisableAA then
                ...
                local Pitch =
                    ...
                    values.rage.angles["pitch"].Dropdown == "random" and RANDOM(-10, 10) / 10 or
                ...
                if
                    values.rage.angles["extend pitch"].Toggle and
                        ...
                        values.rage.angles["pitch"].Dropdown == "Random AA" and 148 or
                        values.rage.angles["pitch"]
                 then
                    Pitch = (Pitch * 2) / 1.6
                end
...
LocalPlayer.Additionals.TotalDamage:GetPropertyChangedSignal("Value"):Connect(
    function(current)
        ...
        sound.SoundId =
            ...
            values.visuals.world.hitsound.Dropdown == "cod" and "rbxassetid://5447626464" or
            ...
            "rbxassetid://6607204501" or
            values.visuals.world.hitsound.Dropdown == "minecraft" and "rbxassetid://6361963422" or
            values.visuals.world.hitsound.Dropdown == "godlike" and "rbxassetid://205020732" or
            values.visuals.world.hitsound.Dropdown == "fard" and "rbxassetid://743178171"
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(
    function(current)
        ...
        if values.misc.chat["kill say"].Toggle then
            game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(
                values.misc.chat["message"].Text ~= "1'd by Finity R.I.P" and values.misc.chat["message"].Text or
                    "2 ez for Finity" and values.misc.chat["message"].Text or
                    "beamed by Finity",
                false,
                "Innocent",
                false,
...
RayIgnore.ChildAdded:Connect(
    function(obj)
        if obj.Name == "Fires" then
            obj.ChildAdded:Connect(
                function(fire)
...
if RayIgnore:FindFirstChild("Fires") then
    RayIgnore:FindFirstChild("Fires").ChildAdded:Connect(
        function(fire)
            if values.visuals.world["molly radius"].Toggle then
                fire.Transparency = values.visuals.world["molly radius"].Transparency
                fire.Color = values.visuals.world["molly radius"].Color
...
if RayIgnore:FindFirstChild("Smokes") then
    ...
    RayIgnore:FindFirstChild("Smokes").ChildAdded:Connect(
        function(smoke)
            RunService.RenderStepped:Wait()
            local OriginalRate = INST("NumberValue")
            OriginalRate.Value = smoke.ParticleEmitter.Rate
...
Camera.ChildAdded:Connect(
    function(obj)
        if TBLFIND(values.misc.client["gun modifiers"].Jumbobox, "ammo") then
            Client.ammocount = 1000000000000000000000
            Client.primarystored = 1000000000000000000000
            Client.ammocount2 = 1000000000000000000000
            Client.secondarystored = 1000000000000000000000
        end
        RunService.RenderStepped:Wait()
...
CreateHitElement("loaded!", Color3.new(0, 1, 0))
and
