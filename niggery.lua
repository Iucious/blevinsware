...
local Signal =
    loadstring(
    game:HttpGet("https://raw.githubusercontent.com/Quenty/NevermoreEngine/version2/Modules/Shared/Events/Signal.lua")
)()
...
local cfglocation = "blevinsware/"
makefolder("blevinsware")
...
function library:New(name)
    ...
    local NBlevins = INST("ScreenGui")
    local Menu = INST("ImageLabel")
    local TextLabel = INST("TextLabel")
    local TabButtons = INST("Frame")
    local UIListLayout = INST("UIListLayout")
    local Tabs = INST("ScrollingFrame")

    NBlevins.Name = "electric boogalo"
    NBlevins.ResetOnSpawn = false
    NBlevins.ZIndexBehavior = "Global"
    NBlevins.DisplayOrder = 420133769

    local UIScale = INST("UIScale")
    UIScale.Parent = NBlevins
    ...
    game:GetService("RunService").RenderStepped:connect(
        function()
            cursor.Visible = NBlevins.Enabled
            cursor.Position = UDIM2(0, Mouse.X - 3, 0, Mouse.Y + 1)
        end
    )

    Menu.Name = "Menu"
    Menu.Parent = NBlevins
    ...
    game:GetService("UserInputService").InputBegan:Connect(
        function(key)
            if key.KeyCode == Enum.KeyCode.Insert then
                NBlevins.Enabled = not NBlevins.Enabled
                library.uiopen = NBlevins.Enabled
            end
        end
    )
    ...
    do
        ...
        local function update(input)
            ...
            a.Position =
                UDIM2(startPos.X.Scale, startPos.X.Offset + delta.X, startPos.Y.Scale, startPos.Y.Offset + delta.Y)
        end
    ...
    TextLabel.Size =
        UDIM2(0, txt:GetTextSize(name, 15, Enum.Font.SourceSansSemibold, Vec2(700, TextLabel.AbsoluteSize.Y)).X, 0, 29)
    TextLabel.Font = Enum.Font.SourceSansSemibold
    TextLabel.Text = name
    TextLabel.TextColor3 = COL3RGB(255, 255, 255)
    ...
    function menu:Tab(text)
            ...
            function()
                if currenttab ~= text then
                    for i, v in pairs(TabButtons:GetChildren()) do
                        if v:IsA("TextButton") then
                            library:Tween(
                                ...
                                {TextColor3 = COL3RGB(200, 200, 200)}
                            )
                        end
                    end
                    ...
                    library:Tween(
                        TextButton,
                        TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        {TextColor3 = COL3RGB(255, 255, 255)}
                    )
                    currenttab = text
                    TabGui.Visible = true
                end
        ...
        function Tab:MSector(text, side)
            ...
            function MSector:Tab(text)
                ...
                TextButton.Size =
                    UDIM2(0, txt:GetTextSize(text, 14, Enum.Font.SourceSansSemibold, Vec2(700, 700)).X + 2, 1, 0)
                TextButton.Font = Enum.Font.SourceSansSemibold
                TextButton.Text = text
                TextButton.TextColor3 = COL3RGB(200, 200, 200)
                ...
                function tab:Element(type, text, data, callback)
                    ...
                    elseif type == "ToggleKeybind" then
                        ...
                        local function update()
                            if Element.value.Toggle then
                                tween =
                                    ...
                                    Color,
                                    TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                    {BackgroundColor3 = COL3RGB(155, 22, 66)}
                                )
                                library:Tween(
                                    TextLabel,
                                    TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                ...
                                tween =
                                    ...
                                    Color,
                                    TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                    {BackgroundColor3 = COL3RGB(33, 35, 47)}
                                )
                                library:Tween(
                                    TextLabel,
                                    TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        ...
                        do
                            ...
                            Keybind.Size =
                                UDIM2(
                                0,
                                txt:GetTextSize("NONE", 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X + 5,
                                0,
                                12
                            )
                            ...
                            Keybind.MouseButton1Down:Connect(
                                function()
                                    if not binding then
                                        wait()
                                        binding = true
                                        ...
                                        Keybind.Size =
                                            UDIM2(
                                            0,
                                            txt:GetTextSize("...", 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X +
                                                4,
                                            0,
                                            12
                                        )
                            ...
                            Keybind.MouseButton2Down:Connect(
                                function()
                                    if not binding then
                            ...
                            game:GetService("UserInputService").InputBegan:Connect(
                                function(input)
                                    if
                                        input.UserInputType == Enum.UserInputType.MouseButton1 or
                                            input.UserInputType == Enum.UserInputType.MouseButton2 and not binding
                                     then
                                    ...
                                    if binding then
                                        ...
                                        Element.value.Key =
                                            input.KeyCode.Name ~= "Unknown" and input.KeyCode.Name or
                    ...
                    elseif type == "ToggleColor" then
                        ...
                        Element.value = {
                            Toggle = data.default and data.default.Toggle or false,
                            Color = data.default and data.default.Color or COL3RGB(255, 255, 255)
                        }
                        ...
                        local function update()
                            if Element.value.Toggle then
                                tween =
                                    ...
                                    Color,
                                    TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                    {BackgroundColor3 = COL3RGB(155, 155, 155)}
                                )
                                library:Tween(
                                    TextLabel,
                                    TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        ...
                        ColorP.MouseButton1Down:Connect(
                            function()
                                Frame.Visible = not Frame.Visible
                            end
                        )
                        local abc = false
                        local inCP = false
                        ColorP.MouseEnter:Connect(
                            function()
                                abc = true
                            end
                        )
                        ColorP.MouseLeave:Connect(
                            function()
                                abc = false
                            end
                        )
                        ...
                        ColorH =
                            (CLAMP(Huedrag.AbsolutePosition.Y - Huepick.AbsolutePosition.Y, 0, Huepick.AbsoluteSize.Y) /
                            Huepick.AbsoluteSize.Y)
                        ColorS =
                            1 -
                            (CLAMP(
                                ColorDrag.AbsolutePosition.X - Colorpick.AbsolutePosition.X,
                                0,
                        ...
                        ColorV =
                            1 -
                            (CLAMP(
                                ColorDrag.AbsolutePosition.Y - Colorpick.AbsolutePosition.Y,
                                0,
                        ...
                        local function updateColor()
                            local ColorX =
                                (CLAMP(mouse.X - Colorpick.AbsolutePosition.X, 0, Colorpick.AbsoluteSize.X) /
                                Colorpick.AbsoluteSize.X)
                            local ColorY =
                                (CLAMP(mouse.Y - Colorpick.AbsolutePosition.Y, 0, Colorpick.AbsoluteSize.Y) /
                                Colorpick.AbsoluteSize.Y)
                        ...
                        Colorpick.MouseButton1Down:Connect(
                            function()
                                updateColor()
                                moveconnection =
                                    mouse.Move:Connect(
                        ...
                        Huepick.MouseButton1Down:Connect(
                            function()
                                updateHue()
                                moveconnection =
                                    mouse.Move:Connect(
                    ...
                    elseif type == "ToggleTrans" then
                        ...
                        Transpick.MouseButton1Down:Connect(
                            function()
                                updateTrans()
                                moveconnection =
                                    mouse.Move:Connect(
                    ...
                    elseif type == "Slider" then
                        ...
                        UIGradient.Color =
                            ColorSequence.new {
                            ColorSequenceKeypoint.new(0, COL3RGB(153, 22, 65)),
                            ColorSequenceKeypoint.new(1, COL3RGB(109, 16, 46))
                        }
                        ...
                        Button.MouseButton1Down:Connect(
                            function()
                                ...
                                val =
                                    FLOOR(
                                    (((tonumber(max) - tonumber(min)) / 175) * Frame.AbsoluteSize.X) + tonumber(min)
                                ) or 0
                                Value.Text = val
                                ...
                                moveconnection =
                                    ...
                                    function()
                                        ...
                                        val =
                                            FLOOR(
                                            (((tonumber(max) - tonumber(min)) / 175) * Frame.AbsoluteSize.X) +
                                                tonumber(min)
                                        )
                                        Value.Text = val
                                        Element.value.Slider = val
                                ...
                                releaseconnection =
                                    ...
                                    function(Mouse)
                                        if Mouse.UserInputType == Enum.UserInputType.MouseButton1 then
                                            Frame.Size =
                                                UDIM2(0, CLAMP(mouse.X - Frame.AbsolutePosition.X, 0, 175), 0, 5)
                                            val =
                                                FLOOR(
                                                (((tonumber(max) - tonumber(min)) / 175) * Frame.AbsoluteSize.X) +
                                                    tonumber(min)
                    ...
                    elseif type == "Button" then
                        ...
                        Button_2.MouseButton1Down:Connect(
                            function()
            ...
            function Sector:Element(type, text, data, callback)
                ...
                elseif type == "Scroll" then
                    ...
                    function Element:SetValue(val)
                        ...
                        library:Tween(
                            Frame[Element.value.Scroll].TextLabel,
                            TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                            {TextColor3 = COL3RGB(255, 255, 255)}
                        )
                        values[tabname][sectorname][text] = Element.value
                            ...
                            function()
                                if not binding then
                                    ...
                                    Keybind.Size =
                                        UDIM2(
                                        0,
                                        txt:GetTextSize("...", 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X + 4,
                                        0,
                                        12
                                    )
                                end
                            ...
                            function(input)
                                ...
                                if binding then
                                    ...
                                    Keybind.Size =
                                        UDIM2(
                                        0,
                                        txt:GetTextSize(Keybind.Text, 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X +
                                            5,
                                        0,
                                        12
                                    )
                    ...
                    local function update()
                        if Element.value.Toggle then
                            tween =
                                ...
                                Color,
                                TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                {BackgroundColor3 = COL3RGB(155, 26, 66)}
                            )
                            library:Tween(
                                TextLabel,
                                TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                ...
                elseif type == "ToggleColor" then
                    ...
                    ColorS =
                        1 -
                        (CLAMP(ColorDrag.AbsolutePosition.X - Colorpick.AbsolutePosition.X, 0, Colorpick.AbsoluteSize.X) /
                            Colorpick.AbsoluteSize.X)
                    ColorV =
                        1 -
                        (CLAMP(ColorDrag.AbsolutePosition.Y - Colorpick.AbsolutePosition.Y, 0, Colorpick.AbsoluteSize.Y) /
                            Colorpick.AbsoluteSize.Y)
                ...
                elseif type == "Slider" then
                    ...
                    Button.MouseButton1Down:Connect(
                        function()
                            Frame.Size = UDIM2(0, CLAMP(mouse.X - Frame.AbsolutePosition.X, 0, 175), 0, 5)
                            val =
                                FLOOR((((tonumber(max) - tonumber(min)) / 175) * Frame.AbsoluteSize.X) + tonumber(min)) or
                                0
                            Value.Text = val
                            Element.value.Slider = val
                            values[tabname][sectorname][text] = Element.value
...
do
    ...
    Frame.BackgroundColor3 = COL3RGB(45, 45, 45)
    Frame.BorderSizePixel = 0
    Frame.Position = UDIM2(0, 0, 0.5, 0)
    Frame.Size = UDIM2(1, 0, 0, 1)

    Frame_2.Parent = ScreenGui
    Frame_2.BackgroundColor3 = COL3RGB(45, 45, 45)
...
local function UpdateAccessory(Accessory)
    Accessory.Material =
        values.visuals.effects["accessory material"].Dropdown == "Smooth" and "SmoothPlastic" or "ForceField"
...
local function UpdateWeapon(obj)
    ...
    if obj:IsA("MeshPart") and selected == "ForceField" then
        ...
        elseif values.visuals.effects["forcefield type"].Dropdown == "scanning" then
            obj.TextureID = "rbxassetid://5843010904"
        elseif values.visuals.effects["forcefield type"].Dropdown == "bubbles" then
            obj.TextureID = "rbxassetid://1461576423"
        end
    else
        if selected == "Smooth" or selected == "Glass" or selected == "Flat" then
            obj.TextureID = ""
        end
    end
    ...
    obj.Material =
        selected == "Smooth" and "SmoothPlastic" or selected == "Flat" and "Neon" or
        selected == "ForceField" and "ForceField" or
        "Glass"
...
makefolder("blevinsware-lua")

local allluas = {}

for _, lua in pairs(listfiles("blevinsware-lua")) do
    local luaname = GSUB(lua, "blevinsware-lua\\", "")
    INSERT(allluas, luaname)
end

RunService.RenderStepped:Wait()

local gui = library:New(customname)
...
luascripts:Element(
    ...
    {},
    function()
        loadstring(readfile("blevinsware-lua\\" .. values.luas["lua scripts"].lua.Scroll))()
    end
)
...
characters:Element(
    "Scroll",
    "skin",
    {options = AllCharacters, Amount = 9, alphabet = true},
    function(tbl)
...
aimbot:Element("Jumbobox", "resolver", {options = {"Predict Angles (BUGGY)", "animation"}})
aimbot:Element("Toggle", "wait until enemy visible")
...
antiaim:Element(
    "Dropdown",
    "yaw base",
    {options = {"camera", "targets", "spin", "random", "anti crippin'", "keybind yaw"}}
)
...
antiaim:Element("Dropdown", "pitch", {options = {"none", "up", "down", "zero", "180", "imposter", "random"}})
...
others:Element("Dropdown", "leg movement", {options = {"off", "slide", "slide2"}})
...
fakelag:Element(
    "ToggleColor",
    "visualize lag",
    {default = {Toggle = false, Color = COL3RGB(255, 255, 255)}},
    function(tbl)
        if tbl.Toggle then
...
coroutine.wrap(
    function()
        while wait(1 / 16) do
            ...
            if
                LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("UpperTorso") and
                    values.rage.fakelag.enabled.Toggle and
                    values.rage.fakelag.enabled.Active
             then
                if
                    LagTick ==
                        (values.rage.fakelag.amount.Dropdown == "static" and values.rage.fakelag.limit.Slider or
                            RANDOM(1, values.rage.fakelag.limit.Slider))
                 then
                    game:GetService("NetworkClient"):SetOutgoingKBPSLimit(9e9)
                    FakelagFolder:ClearAllChildren()
                    LagTick = 0
...
exploits:Element("Slider", "tap amount", {min = 2, max = 15, default = 2})
local AutoPeek = {
...
effects:Element(
    "ToggleTrans",
    "weapon chams",
    {default = {Color = COL3RGB(255, 255, 255), Transparency = 0}},
    function(tbl)
...
effects:Element(
    "ToggleTrans",
    "accessory chams",
    {default = {Color = COL3RGB(255, 255, 255)}},
    function(val)
...
LocalPlayer:GetPropertyChangedSignal("CameraMinZoomDistance"):Connect(
    function(current)
        if values.visuals.self["third person"].Toggle then
            if values.visuals.self["third person"].Active then
...
self:Element(
    ...
    function(val)
        ViewmodelOffset =
            CFrame.new(
            values.visuals.self["viewmodel x"].Slider / 100,
            values.visuals.self["viewmodel y"].Slider / 100,
            values.visuals.self["viewmodel z"].Slider / 100
        ) * CFrame.Angles(0, 0, values.visuals.self.roll.Slider / 180)
    end
)
self:Element(
    "Slider",
                ...
                for _, part in pairs(LocalPlayer.Character:GetDescendants()) do
                    if part:IsA("Part") or part:IsA("MeshPart") then
                        if part.Transparency ~= 1 then
                            part.Transparency =
                                LocalPlayer.Character:FindFirstChild("AIMING") and
        ...
        if tbl.Toggle then
            ...
            if nigger1 == true then
                ...
                function funcs:Beam(v1, v2)
                    ...
                    Beam.Color =
                        ColorSequence.new {
                        ColorSequenceKeypoint.new(0, values.visuals.world["color_for_bullet_tracer"].Color),
                        ColorSequenceKeypoint.new(1, values.visuals.world["color_for_bullet_tracer"].Color)
                    }
                ...
                mt.__namecall =
                    ...
                    function(self, ...)
                        local args = {...}
                        if
                            getnamecallmethod() == "FireServer" and self.Name == "HitPart" and
                                tick() - lasthittick > 0.005
                         then
                            lasthittick = tick()
                            spawn(
                                function()
...
world:Element(
    "Dropdown",
    "skybox",
    {options = {"none", "nebula", "vaporwave", "clouds"}},
    function(tbl)
        ...
        for i, weapon in pairs(workspace.Debris:GetChildren()) do
            if weapon:IsA("BasePart") and Weapons:FindFirstChild(weapon.Name) then
                weapon.BillboardGui.ImageLabel.Visible =
                    tbl.Toggle and TBLFIND(values.visuals.world["types"].Jumbobox, "icon") and true or false
            end
        end
    end
)
world:Element(
    ...
    function(tbl)
        for i, weapon in pairs(workspace.Debris:GetChildren()) do
            if weapon:IsA("BasePart") and Weapons:FindFirstChild(weapon.Name) then
                weapon.BillboardGui.ImageLabel.Visible =
                    values.visuals.world["item esp"].Toggle and TBLFIND(tbl.Jumbobox, "icon") and true or false
                    ...
                    pcall(
                        function()
                            ...
                            Trail.Color =
                                ...
                                ColorSequenceKeypoint.new(0.24, Color3.fromRGB(243, 255, 0)),
                                ColorSequenceKeypoint.new(0.42, Color3.fromRGB(4, 246, 0)),
                                ColorSequenceKeypoint.new(0.65, Color3.fromRGB(0, 221, 255)),
                                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 0, 209))
                            }
                        end
                    )
...
client:Element(
    ...
    function(tbl)
        if tbl.Toggle then
            ...
            Frame.Position = UDim2.new(0.316663027, 0, 0.302197814, 0)
            Frame.Size = UDim2.new(0, 437, 0, 24)

            Frame_2.Parent = Frame
            Frame_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            Frame_2.BorderColor3 = Color3.fromRGB(255, 255, 255)
            Frame_2.BorderSizePixel = 0
            Frame_2.Position = UDim2.new(0, 0, -0.00890095998, 0)
            Frame_2.Size = UDim2.new(0, 437, 0, 1)

            UIGradient.Color =
                ColorSequence.new {
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(60, 79, 255)),
                ColorSequenceKeypoint.new(0.12, Color3.fromRGB(131, 202, 255)),
                ColorSequenceKeypoint.new(0.72, Color3.fromRGB(131, 202, 255)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(131, 202, 255))
            }
            UIGradient.Rotation = 90
            ...
            TextLabel.BackgroundTransparency = 1.000
            TextLabel.Size = UDim2.new(0, 110, 0, 24)
            TextLabel.Font = Enum.Font.SourceSans
            TextLabel.Text = "blevinsware"
            ...
            TextLabel_2.Position = UDim2.new(0.266236097, 0, 0.208333328, 0)
            ...
            TextLabel_3.BackgroundTransparency = 1.000
            TextLabel_3.Position = UDim2.new(0.496661127, 0, 0, 0)
            TextLabel_3.Size = UDim2.new(0, 110, 0, 24)
            TextLabel_3.Font = Enum.Font.SourceSans
            TextLabel_3.Text = "Last Updated: May 26, 22"
            ...
            TextLabel_4.Position = UDim2.new(0.250238746, 0, 0, 0)
            TextLabel_4.Size = UDim2.new(0, 0, 0, 24)
            ...
            TextLabel_5.Position = UDim2.new(0.498648107, 0, -0.0416666679, 0)
            TextLabel_5.Size = UDim2.new(0, 0, 0, 24)
            ...
            UIGradient_2.Color =
                ...
                ColorSequenceKeypoint.new(0.37, Color3.fromRGB(45, 45, 45)),
            ...
            TextLabel_6.Position = UDim2.new(0.746806264, 0, -0.0416666679, 0)
            TextLabel_6.Size = UDim2.new(0, 0, 0, 24)
            ...
            TextLabel_7.Position = UDim2.new(0.748377383, 0, 0, 0)
            TextLabel_7.Size = UDim2.new(0, 110, 0, 24)
            TextLabel_7.Font = Enum.Font.SourceSans
            TextLabel_7.Text = "00:00:00"
        ...
        if tbl.Toggle then
            while values.misc.chat["chat spam"].Toggle do
                game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(
                    values.misc.chat.type.Dropdown == "standard" and "Get good" or "buy stormy.solutions",
                    false,
                    "Innocent",
                    false,
                    true
...
grenades:Element(
    "Dropdown",
    "grenade",
    {options = {"Flashbang", "Smoke Grenade", "Molotov", "HE Grenade", "Decoy Grenade"}}
)
grenades:Element(
    "Button",
    "crash server",
    ...
    function()
        RunService.RenderStepped:Connect(
            function()
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("UpperTorso") then
                    local oh1 =
                        game:GetService("ReplicatedStorage").Weapons[values.misc.grenades.grenade.Dropdown].Model
                    local oh3 = 25
                    local oh4 = 35
                    local oh6 = ""
                    local oh7 = ""
...
workspace.Debris.ChildAdded:Connect(
    function(obj)
        if obj:IsA("BasePart") and Weapons:FindFirstChild(obj.Name) then
            ...
            ImageLabel.ScaleType = Enum.ScaleType.Fit
            ImageLabel.Visible =
                values.visuals.world["item esp"].Toggle and TBLFIND(values.visuals.world["types"].Jumbobox, "icon") and
                true or
                false
...
for _, obj in pairs(workspace.Debris:GetChildren()) do
    if obj:IsA("BasePart") and Weapons:FindFirstChild(obj.Name) then
        ...
        ImageLabel.ScaleType = Enum.ScaleType.Fit
        ImageLabel.Visible =
            values.visuals.world["item esp"].Toggle and TBLFIND(values.visuals.world["types"].Jumbobox, "icon") and true or
            false
...
local function GetWeaponRage(weapon)
    return TBLFIND(weps.Pistol, weapon) and "pistol" or TBLFIND(weps.Rifle, weapon) and "rifle" or
        weapon == "AWP" and "awp" or
        weapon == "G3SG1" and "auto" or
        weapon == "Scout" and "scout" or
        "default"
end
...
local function GetWeaponLegit(weapon)
    return TBLFIND(weps2.Pistol, weapon) and "pistol" or TBLFIND(weps2.Rifle, weapon) and "rifle" or
        TBLFIND(weps2.SMG, weapon) and "smg" or
        TBLFIND(weps2.Sniper, weapon) and "sniper" or
        "default"
end
    ...
    function(step)
        ...
        if values.rage.angles["underground aa"].Toggle == true and underground == false then
            LocalPlayer.Character.LowerTorso.Root.C0 =
                LocalPlayer.Character.LowerTorso.Root.C0 * CFrame.Angles(0, 0, 0) *
        ...
        if PlayerIsAlive then
            ...
            if workspace:FindFirstChild("Map") and Client.gun ~= "none" and Client.gun.Name ~= "C4" then
                if values.rage.aimbot.enabled.Toggle then
                    local Origin =
                        ...
                        LocalPlayer.Character.LowerTorso.Position + Vec3(0, 2.5, 0) or
                        CamCFrame.p
                    ...
                    for _, Player in pairs(Players:GetPlayers()) do
                        ...
                        if
                            Player.Character and Player.Character:FindFirstChild("Humanoid") and
                                ...
                                Player ~= LocalPlayer
                         then
                            if TBLFIND(values.rage.aimbot.resolver.Jumbobox, "Predict Angles (BUGGY)") then
                                Player.Character.Body.Pelvis.C0 = CFrame.new(-3, 2, -3) * CFAngles(0, 0, 0)
                            end
                        ...
                        if
                            Player.Character and Player.Character:FindFirstChild("Humanoid") and not Client.DISABLED and
                                Player.Character:FindFirstChild("Humanoid").Health > 0 and
                                Player.Team ~= "TTT" and
                                not Player.Character:FindFirstChildOfClass("ForceField") and
                                GetDeg(CamCFrame, Player.Character.Head.Position) <= Stats["max fov"].Slider and
                                Player ~= LocalPlayer
                         then
                            if
                                Player.Team ~= LocalPlayer.Team or
                                    ...
                                    for _, Hitbox in ipairs(Hitboxes) do
                                        ...
                                        if values.rage.aimbot["automatic penetration"].Toggle then
                                            ...
                                            local Ray1 =
                                                RAY(
                                                Origin,
                                                (Hitbox.Position - Origin).unit * (Hitbox.Position - Origin).magnitude
                                            )
                                            repeat
                                                Hit, Pos =
                                            ...
                                            if EndHit ~= nil and Multipliers[EndHit.Name] ~= nil and #Hits <= 4 then
                                                if #Hits == 0 then
                                                    ...
                                                    if Player:FindFirstChild("Kevlar") then
                                                        if FIND(EndHit.Name, "Head") then
                                                            if Player:FindFirstChild("Helmet") then
                                                                Damage =
                                                                    (Damage / 100) * Client.gun.ArmorPenetration.Value
                                                            end
                                                        else
                                                    ...
                                                    Damage =
                                                        Damage *
                                                        (Client.gun.RangeModifier.Value /
                                                            100 ^ ((Origin - EndHit.Position).Magnitude / 500)) /
                                                        100
                                                    if Damage >= Stats["minimum damage"].Slider then
                                                        ...
                                                        if values.rage.aimbot["automatic fire"].Dropdown == "standard" then
                                                            Client.firebullet()
                                                            if
                                                                values.rage.exploits["custom tap"].Toggle and
                                                                    values.rage.exploits["custom tap"].Active
                                                             then
                                                    ...
                                                    for i = 1, #Hits do
                                                        ...
                                                        if
                                                            part.Material == Enum.Material.CorrodedMetal or
                                                                part.Material == Enum.Material.Metal or
                                                        ...
                                                        if
                                                            part.Name == "Grate" or part.Material == Enum.Material.Wood or
                                                        ...
                                                        if
                                                            part.Transparency == 1 or part.CanCollide == false or
                                                                part.Name == "Glass" or
                                                                part.Name == "Cardboard"
                                                         then
                                                            modifier = 0
                                                    ...
                                                    local Damage =
                                                        Client.gun.DMG.Value * Multipliers[EndHit.Name] * dmgmodifier
                                                    if Player:FindFirstChild("Kevlar") then
                                                        if FIND(EndHit.Name, "Head") then
                                                            if Player:FindFirstChild("Helmet") then
                                                                Damage =
                                                    ...
                                                    if Damage >= Stats["minimum damage"].Slider then
                                                        ...
                                                        elseif
                                                         ...
                                                         then
                                                            ...
                                                            game.ReplicatedStorage.Events.HitPart:erver(
                                                                unpack(Arguments)
                                                            )
                                                            if
                                                                values.rage.exploits["custom tap"].Toggle and
                                            ...
                                            if Hit and Multipliers[Hit.Name] ~= nil then
                                                ...
                                                Damage =
                                                    Damage *
                                                    (Client.gun.RangeModifier.Value /
                                                        100 ^ ((Origin - Hit.Position).Magnitude / 500))
                                                if Damage >= Stats["minimum damage"].Slider then
                                                    RageGuy = Hit
                                                    RageTarget = Hit
                                                    if not values.rage.aimbot["silent aim"].Toggle then
                ...
                elseif
                 ...
                 then
                    ...
                    if
                        not TBLFIND(Stats.conditions.Jumbobox, "blind") or
                            LocalPlayer.PlayerGui.Blnd.Blind.BackgroundTransparency > 0.9
                     then
                                 ...
                                 then
                                    if
                                     ...
                                     then
                                        if
                                            Player.Team ~= LocalPlayer.Team or
                                                values.legit.settings["free for all"].Toggle
                                         then
                                            local Pos, onScreen =
                                                Camera:WorldToViewportPoint(Player.Character.HumanoidRootPart.Position)
                                            if onScreen then
                                                local Magnitude =
                                                    (Vec2(Pos.X, Pos.Y) - Vec2(Mouse.X, Mouse.Y)).Magnitude
                                                if Magnitude < Stats["field of view"].Slider then
                                                    local Hitbox =
                                                        Stats.hitbox.Dropdown == "head" and Player.Character.Head or
                                                    ...
                                                    if Stats.hitbox.Dropdown == "closest" then
                                                        ...
                                                        local HeadDistance =
                                                            (Vec2(HeadPos.X, HeadPos.Y) - Vec2(Mouse.X, Mouse.Y)).Magnitude
                                                        local TorsoDistance =
                                                            (Vec2(TorsoPos.X, TorsoPos.Y) - Vec2(Mouse.X, Mouse.Y)).Magnitude
                                                        ...
                                                        if not TBLFIND(Stats.conditions.Jumbobox, "visible") then
                                                            ...
                                                            local Ray1 =
                                                                ...
                                                                (Hitbox.Position - Camera.CFrame.Position).unit *
                                                                    (Hitbox.Position - Camera.CFrame.Position).magnitude
                                                            )
                                                            local Hit, Pos =
                    ...
                    if Stats.triggerbot.Toggle then
                        if
                         ...
                         then
                            if not TBLFIND(Stats.conditions.Jumbobox, "standing") or SelfVelocity.Magnitude < 3 then
                                if
                                    Mouse.Target and Mouse.Target.Parent and
                                        Players:GetPlayerFromCharacter(Mouse.Target.Parent) and
                                        Multipliers[Mouse.Target.Name] ~= nil and
                                        Client.gun.DMG.Value * Multipliers[Mouse.Target.Name] >=
                                            Stats["minimum dmg"].Slider
                                 then
                                    ...
                                    if Player.Team ~= LocalPlayer.Team or values.legit.settings["free for all"].Toggle then
                                        coroutine.wrap(
                                            function()
                                                ...
                                                until Mouse.Target == nil or
                                                    Player ~= Players:GetPlayerFromCharacter(Mouse.Target.Parent)
            ...
            if UserInputService:IsKeyDown("Space") and values.misc.movement["bunny hop"].Toggle then
                ...
                if
                    values.misc.movement.type.Dropdown == "gyro" and
                        values.misc.movement["gyro type"].Dropdown == "no fling"
                 then
                ...
                BodyVelocity.Velocity =
                    Vec3(rot.LookVector.X, 0, rot.LookVector.Z) * (values.misc.movement["speed"].Slider * 2)
                if
                    add == 0 and values.misc.movement.direction.Dropdown == "directional" and
                        not UserInputService:IsKeyDown("W")
                 then
                    BodyVelocity:Destroy()
            ...
            if values.misc.movement["edge jump"].Toggle and values.misc.movement["edge jump"].Active then
                if
                    LocalPlayer.Character.Humanoid:GetState() ~= Enum.HumanoidStateType.Freefall and
                        LocalPlayer.Character.Humanoid:GetState() ~= Enum.HumanoidStateType.Jumping
                 then
                    coroutine.wrap(
                        function()
                            RunService.RenderStepped:Wait()
                            if
                                LocalPlayer.Character ~= nil and LocalPlayer.Character:FindFirstChild("Humanoid") and
                                    LocalPlayer.Character.Humanoid:GetState() == Enum.HumanoidStateType.Freefall and
                                    LocalPlayer.Character.Humanoid:GetState() ~= Enum.HumanoidStateType.Jumping
                             then
            ...
            if values.rage.angles.enabled.Toggle and not DisableAA then
                ...
                local Offset =
                    ...
                    -values.rage.angles["yaw offset"].Slider -
                        (values.rage.angles.jitter.Toggle and Jitter and values.rage.angles["jitter offset"].Slider or 0)
                )
                    ...
                    for _, plr in pairs(Players:GetPlayers()) do
                        if
                            plr.Character and plr.Character:FindFirstChild("Humanoid") and
                                plr.Character:FindFirstChild("Humanoid").Health > 0 and
                ...
                if values.rage.angles["body roll"].Dropdown == "180" then
                    Root.CFrame =
                        Root.CFrame *
                        CFAngles(values.rage.angles["body roll"].Dropdown == "180" and RAD(180) or 0, 1, 0)
                    LocalPlayer.Character.Humanoid.HipHeight = 4
                elseif values.rage.angles["body roll"].Dropdown == "spin" then
                    LocalPlayer.Character.LowerTorso.Root.C0 =
                        LocalPlayer.Character.LowerTorso.Root.C0 * CFrame.Angles(0, 0, math.pi / 10) *
                        CFrame.new(0, 0, 0)
                else
                ...
                local Pitch =
                    values.rage.angles["pitch"].Dropdown == "none" and CamLook.Y or
                    ...
                    values.rage.angles["pitch"].Dropdown == "random" and math.random(-10, 10) / 10 or
                    2.5
                if
                    values.rage.angles["extend pitch"].Toggle and
                        (values.rage.angles["pitch"].Dropdown == "up" or values.rage.angles["pitch"].Dropdown == "down")
                 then
                    Pitch = (Pitch * 2) / 1.6
                end
                ...
                LocalPlayer.Character.Humanoid.HipHeight = 2
                Root.CFrame =
                    CFrame.new(Root.Position) * CFrame.Angles(0, -math.atan2(CamLook.Z, CamLook.X) + math.rad(270), 0)
                game.ReplicatedStorage.Events.ControlTurn:FireServer(
                    CamLook.Y,
                    LocalPlayer.Character:FindFirstChild("Climbing") and true or false
                )
        ...
        for _, Player in pairs(Players:GetPlayers()) do
            if
                Player.Character and Player ~= LocalPlayer and Player.Character:FindFirstChild("HumanoidRootPart") and
             ...
             then
                coroutine.wrap(
                    function()
                        ...
                        RunService.RenderStepped:Wait()
                        if
                            Player.Character and Player ~= LocalPlayer and
            ...
            if
             ...
             then
                ...
                local Size =
                    ...
                    Camera:WorldToViewportPoint(RootPosition + Vec3(0, 2.6, 0)).Y) /
                    2
                ...
                if values.visuals.players.weapon.Toggle then
                    ...
                    tbl.Weapon.Position =
                        Vec2(tbl.Box.Size.X / 2 + tbl.Box.Position.X, tbl.Box.Size.Y + tbl.Box.Position.Y + 1)
                ...
                if values.visuals.players["weapon icon"].Toggle then
                    ...
                    Items[Player.Name].Position =
                        UDIM2(
                        0,
                        tbl.Box.Size.X / 2 + tbl.Box.Position.X,
                        0,
                        tbl.Box.Size.Y + tbl.Box.Position.Y + (values.visuals.players.weapon.Toggle and -10 or -22)
                    )
...
mt.__namecall = function(self, ...)
    ...
    if method == "SetPrimaryPartCFrame" and self.Name == "Arms" then
        if
            values.visuals.self["third person"].Toggle and values.visuals.self["third person"].Active and
                LocalPlayer.Character
         then
            ...
            if values.visuals.self["visualize silent angle"].Toggle and RageTarget then -- is it enabled and are we aimbotting at someone?
             ...
             -- if yes, apply the cframe.lookat on top of the viewmodel offset
            end
        end
    end
    if method == "SetPrimaryPartCFrame" and self.Name ~= "Arms" then
    ...
    if method == "FireServer" then
        if LEN(self.Name) == 38 then
            return
        elseif
            self.Name == "FallDamage" and TBLFIND(values.misc.client["damage bypass"].Jumbobox, "fall") or
        ...
        if not checkcaller() or Filter then
                    ...
                    function()
                                            ...
                                            if
                                             ...
                                             then
                                                ...
                                                if onScreen then
                                                    ...
                                                    if Magnitude < Stats["field of view"].Slider then
                                                        local Hitbox =
                                                            Stats.priority.Dropdown == "head" and Player.Character.Head or
                                                            Stats.priority.Dropdown == "chest" and
                        ...
                        if Target ~= nil and Hit then
                            args[1] =
                                RAY(
                                Camera.CFrame.Position,
                                (Target.Position - Camera.CFrame.Position).unit *
            ...
            if RageTarget ~= nil then
                local Origin =
                    ...
                    LocalPlayer.Character.LowerTorso.Position + Vec3(0, 2.5, 0) or
                    Camera.CFrame.p
                if values.rage.aimbot["wait until enemy visible"].Toggle then
                    spawn(
                        function()
                            args[1] =
                                RAY(
                    ...
                    args[1] =
                        RAY(Origin, (RageTarget.Position - Origin).unit * (RageTarget.Position - Origin).magnitude)
                end
            end
        end
    end
            ...
            coroutine.wrap(
                function()
                    if Players:GetPlayerFromCharacter(args[1].Parent) or args[1] == RageTarget then
                        ...
                        args[2] = args[2] + dir * (Ping / (POW(Ping, 1.0)) * (dir / (dir / 2)))
                        args[4] = 0
                        args[12] = args[12] - 500
                    end
                end
                    ...
                    function()
                        if
                            Players:GetPlayerFromCharacter(args[1].Parent) and
                                Players:GetPlayerFromCharacter(args[1].Parent).Team ~= LocalPlayer.Team
                         then
...
mt.__index =
    ...
    function(self, key)
        ...
        if
            not checkcaller() and self == Viewmodels and LocalPlayer.Character ~= nil and
                LocalPlayer.Character:FindFirstChild("UpperTorso")
         then
...
Crosshairs.Scope:GetPropertyChangedSignal("Visible"):Connect(
    function(current)
...
Crosshair:GetPropertyChangedSignal("Visible"):Connect(
    function(current)
...
LocalPlayer.Additionals.TotalDamage:GetPropertyChangedSignal("Value"):Connect(
    function(current)
        ...
        sound.SoundId =
            values.visuals.world.hitsound.Dropdown == "moan1" and "rbxassetid://2440889605" or
            values.visuals.world.hitsound.Dropdown == "skeet" and "rbxassetid://5447626464" or
            values.visuals.world.hitsound.Dropdown == "neverlose" and "rbxassetid://6607204501" or
            ...
            values.visuals.world.hitsound.Dropdown == "moan2" and "rbxassetid://2440891382" or
            values.visuals.world.hitsound.Dropdown == "moan3" and "rbxassetid://2440889869" or
            values.visuals.world.hitsound.Dropdown == "moan4" and "rbxassetid://2440888376" or
            values.visuals.world.hitsound.Dropdown == "elevator" and "rbxassetid://296102734" or
            values.visuals.world.hitsound.Dropdown == "elevator2" and "rbxassetid://8322227967" or
            values.visuals.world.hitsound.s.world.hitsound.Dropdown
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(
    function(current)
        ...
        if values.misc.chat["kill say"].Toggle then
            game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(
                values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or
                    "get the best by the official ninja blevins!",
                false,
                "Innocent",
                false,
                true
...
Camera.ChildAdded:Connect(
    function(obj)
        if TBLFIND(values.misc.client["gun modifiers"].Jumbobox, "ammo") then
            Client.ammocount = 16
            Client.primarystored = 16
            Client.ammocount2 = 16
            Client.secondarystored = 16
        end
        RunService.RenderStepped:Wait()
        ...
        local gunname =
            Client.gun ~= "none" and values.skins.knife["knife changer"].Toggle and Client.gun:FindFirstChild("Melee") and
            values.skins.knife.model.Scroll or
            Client.gun ~= "none" and Client.gun.Name
...
LocalPlayer.Cash:GetPropertyChangedSignal("Value"):Connect(
    function(cash)
            ...
            function(Character)
                ...
                if Character ~= nil then
                    ...
                    for _, obj in pairs(Character:GetChildren()) do
                        if
                            obj:IsA("BasePart") and Player ~= LocalPlayer and obj.Name ~= "HumanoidRootPart" and
                                obj.Name ~= "Head" and
                                obj.Name ~= "BackC4" and
                                obj.Name ~= "HeadHB"
                         then
...
for _, Player in pairs(Players:GetPlayers()) do
    ...
    if Player.Character ~= nil and Player.Character:FindFirstChild("UpperTorso") then
        ...
        for _, obj in pairs(Player.Character:GetChildren()) do
            CollisionTBL(obj)
            if
                obj:IsA("BasePart") and Player ~= LocalPlayer and obj.Name ~= "HumanoidRootPart" and obj.Name ~= "Head" and
                    obj.Name ~= "BackC4" and
                    obj.Name ~= "HeadHB"
             then
                local VisibleCham = INST("BoxHandleAdornment")
